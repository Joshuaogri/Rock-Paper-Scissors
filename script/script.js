let buttons = document.querySelectorAll('button');
         ...
         let scoretwo= 0;
           ...
           computer.toString();
            ...
            buttons.forEach((button) => {
                button.addEventListener('click', () => {
                    document.getElementById("box").innerHTML= scoreone;
                    document.getElementById("boxy").innerHTML= scoretwo;
                });
            });
            ...
            buttons.forEach((button) => {
                button.addEventListener('click', () => {
                   if (scoreone == 5 || scoretwo == 5)  {
                    let x = document.getElementById("firstpara");
                    document.getElementById("even").style.backgroundColor= "red";
                    document.getElementById("even").style.display = "none";
                    document.getElementById("fix").innerHTML = "GAME OVER!!!";
                    document.getElementById("backup").style.display = "inline";
            ...
            buttons.forEach((button) => {
                button.addEventListener('click', () => {
                   if (scoreone == 5)  {
                    document.getElementById("call").innerHTML= "You won the game!!!";
                    } else if (scoretwo == 5 ){
